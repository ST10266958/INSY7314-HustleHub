...
All Part 1 endpoints were tested using Postman. The full collection — covering successful registration and login, as well as invalid, missing, duplicate, and unauthorised scenarios — is included at backend/postman/HustleHub-Part1.postman_collection.json.

Full test case documentation, including expected vs. actual results and notes on the security-specific tests, is available at backend/docs/part1-testing.md.
